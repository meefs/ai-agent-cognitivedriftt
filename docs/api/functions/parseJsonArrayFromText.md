[@elizaos/eliza v0.1.4-alpha.3](../index.md) / parseJsonArrayFromText
...
[packages/core/src/parsing.ts:60](https://github.com/dabit3/ai-agent-cognitivedriftt/blob/main/packages/core/src/parsing.ts#L60)
