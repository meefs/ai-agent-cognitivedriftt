[@elizaos/eliza v0.1.4-alpha.3](../index.md) / formatEvaluatorExampleDescriptions
...
[packages/core/src/evaluators.ts:110](https://github.com/dabit3/ai-agent-cognitivedriftt/blob/main/packages/core/src/evaluators.ts#L110)
