[@elizaos/eliza v0.1.4-alpha.3](../index.md) / getGoals
...
[packages/core/src/goals.ts:8](https://github.com/dabit3/ai-agent-cognitivedriftt/blob/main/packages/core/src/goals.ts#L8)
