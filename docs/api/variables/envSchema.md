[@elizaos/eliza v0.1.4-alpha.3](../index.md) / envSchema
...
[packages/core/src/environment.ts:5](https://github.com/dabit3/ai-agent-cognitivedriftt/blob/main/packages/core/src/environment.ts#L5)
