[@elizaos/eliza v0.1.4-alpha.3](../index.md) / CharacterSchema
...
[packages/core/src/environment.ts:66](https://github.com/dabit3/ai-agent-cognitivedriftt/blob/main/packages/core/src/environment.ts#L66)
